...
1. Заголовки
2. Работа с выделением текста
3. Использование эмодзи (emoji)
4. Использование цитирования в тексте
5. Подсветка кода
6. Списки [Списки.md](https://github.com/GnuriaN/format-README.md/blob/master/Списки.md)
7. [Ссылки](README.md#Ссылки)
8. [Вставка изображения](README.md#Вставка-изображения)
9. [Вставка таблиц](README.md#Вставка-таблиц)
